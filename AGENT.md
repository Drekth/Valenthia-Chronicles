...
- **Engine:** Unity 6.4 or later
- **Render Pipeline:** Universal Render Pipeline (URP) 17.3.0 or later
- **Input:** New Input System 1.18.0 or later — DO NOT use legacy UnityEngine.Input
...
- **Scene structure:** The project use Single Point approach with additive scene (background for services and in front game level)
...
4. **Keep it simple** - Avoid complex object structures and try to keep the code as simple as possible and easy for users to read.
